  ...
  return (
    <div className="min-h-screen bg-[#060606] text-white font-sans flex flex-col relative overflow-x-hidden">
      ...
      <motion.button
        ...
        className="md:hidden fixed bottom-6 right-6 z-[60] w-14 h-14 bg-[#D4AF37] rounded-full shadow-[0_10px_30px_rgba(212,175,55,0.4)] flex items-center justify-center text-black active:scale-95 transition-all outline-none"
      >
        <motion.div
